      ...
      <div className="max-w-screen-xl mx-auto px-5 pt-10 pb-8 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10">
        ...
        <div className="col-span-2 sm:col-span-2 lg:col-span-1">
          <img
            ...
            className="h-8 max-w-[130px] object-contain mb-3"
      ...
      <div className="border-t border-border/60">
        <div className="max-w-screen-xl mx-auto px-5 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[11px] text-muted-foreground/70 order-2 sm:order-1">
            &copy; {new Date().getFullYear()} <span className="text-foreground/60 font-medium">{settings.appName}</span>. All rights reserved.
          </p>
