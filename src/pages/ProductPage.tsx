        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-10">
          ...
          <div className="px-4 py-4 lg:px-0">
            ...
            <div className="mt-4 grid grid-cols-3 gap-2">
              ...
              <a href={`https://m.me/${settings.email?.split('@')[0] || ''}`} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-1.5 h-10 rounded-xl bg-[#715EB4]/10 text-[#715EB4] text-xs font-semibold hover:bg-[#715EB4]/20 transition-colors border border-[#715EB4]/20">
              ...
              <div className="rounded-2xl bg-card p-4">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  {(isDigital ? [
                    ...
                    { icon: Monitor, label: 'লাইভ ডেমো', sub: 'কেনার আগে দেখুন', color: 'text-[#715EB4] bg-[#715EB4]/10' },
                  ] : [
                    { icon: Banknote, label: 'ক্যাশ অন ডেলিভারি', sub: 'পণ্য পেয়ে পেমেন্ট', color: 'text-green-600 bg-green-500/10' },
                    { icon: Smartphone, label: 'মোবাইল ব্যাংকিং', sub: 'bKash / Nagad', color: 'text-pink-500 bg-pink-500/10' },
                    { icon: RotateCcw, label: '7 দিনে পণ্য ফেরত', sub: 'সহজ রিটার্ন পলিসি', color: 'text-[#715EB4] bg-[#715EB4]/10' },
